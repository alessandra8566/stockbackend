...
def createDB():
  ...
  POSTGRESQL_PASSWORD = 'st910018'
  POSTGRESQL_DBNAME = 'postgres'

  postgres_str = ('postgresql://{username}:{password}@{ipaddress}:{port}/{dbname}').format(username = POSTGRESQL_USERNAME,
                                                                                            password = POSTGRESQL_PASSWORD,
                                                                                            ipaddress = POSTGRESQL_ADDRESS,
